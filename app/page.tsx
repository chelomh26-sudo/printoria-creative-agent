    ...
    <main className="app-shell">
      ...
      <section className="workspace">
        <header className="topbar">
          ...
          <div className="budget-card"><span>Costo estimado</span><strong>{stage === "input" ? "$0.00" : stage === "questions" ? "$0.05" : "$0.08"}</strong><small>Límite $0.80 USD</small></div>
        </header>
        ...
        <div className="content-wrap">
          {stage === "input" && (
            <section className="panel">
              ...
              <div className="panel-actions"><p><span className="spark">✦</span> El análisis no generará ninguna imagen.</p><button className="primary-button" onClick={analyze} type="button">Analizar proyecto <span>→</span></button></div>
            </section>
          )}
          ...
          {stage === "questions" && (
            <section className="panel">
              ...
              <div className="panel-actions"><button className="text-button" onClick={() => setStage("input")} type="button">← Volver</button><button className="primary-button" onClick={() => setStage("plan")} type="button">Crear plan creativo <span>→</span></button></div>
            </section>
          )}
          ...
          {stage === "plan" && (
            <section className="panel">
              ...
              <div className="panel-actions approval-actions"><button className="secondary-button" onClick={() => setStage("questions")} type="button">Ajustar respuestas</button><button className="primary-button" onClick={() => setStage("approved")} type="button">Aprobar plan <span>✓</span></button></div>
            </section>
          )}
